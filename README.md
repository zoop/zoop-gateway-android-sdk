...
5. [ADDING SDK TO YOUR PROJECT](#itrAddSDK)
...
### 1. INTRODUCTION
**Income Tax Department** is the form in which assessee files information about his Income and tax thereon to Income Tax Department. The Zoop ITD Gateway allows allows you to fetch the tax returns of your client and make better business decision on them.
